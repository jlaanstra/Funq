...
namespace Funq.Build
{
	...
	public class CodeGeneration : ISupportInitialize
	{
		...
		{
			AddTypes(types.Select(type => type.FullName));
		}
		...
		{
			if (initialized)
				throw new InvalidOperationException("BeginInit/EndInit have already been called.");
		}

		private void ThrowIfNotInitialized()
		{
			if (!initialized)
				throw new InvalidOperationException("BeginInit/EndInit have not been called.");
		}
